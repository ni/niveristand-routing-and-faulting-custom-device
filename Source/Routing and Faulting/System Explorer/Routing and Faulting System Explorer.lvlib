	...
	<Item Name="System Explorer" Type="Folder">
		<Item Name="Dynamically Called" Type="Folder">
			<Item Name="Extra Pages" Type="Folder">
				...
				<Item Name="Switching.vi" Type="VI" URL="../Switching.vi"/>
			</Item>
		...
		<Item Name="SubVIs" Type="Folder">
			...
			<Item Name="Compile Routing and Faulting Config.vi" Type="VI" URL="../Compile Routing and Faulting Config.vi"/>
			<Item Name="Find All Accessible SLSC Switch CDs.vi" Type="VI" URL="../Find All Accessible SLSC Switch CDs.vi"/>
			<Item Name="Form Value-Connections Map.vi" Type="VI" URL="../Form Value-Connections Map.vi"/>
